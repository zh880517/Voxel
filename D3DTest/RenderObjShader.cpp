...
RenderObjShader::RenderObjShader()
...
bool RenderObjShader::Create(ID3D11Device * pd3dDevice, LPCWSTR strFile)
{
	HRESULT hr = S_OK;
...
void RenderObjShader::OnRender(ID3D11DeviceContext * pd3dImmediateContext, const DirectX::XMMATRIX & mProj, const DirectX::XMMATRIX & mView, const DirectX::XMMATRIX& mWorld)
{
// 	HRESULT hr;
...
HRESULT RenderObjShader::CompileFromFile(LPCWSTR pFileName, const D3D_SHADER_MACRO * pDefines, LPCSTR pEntrypoint, LPCSTR pTarget, UINT Flags1, UINT Flags2, ID3DBlob ** ppCode)
{
	HRESULT hr;
