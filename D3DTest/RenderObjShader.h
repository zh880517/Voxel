...
public:
	...
	virtual void	OnRender(ID3D11DeviceContext* pd3dImmediateContext, const DirectX::XMMATRIX& mProj, const DirectX::XMMATRIX& mView, const DirectX::XMMATRIX& mWorld);
